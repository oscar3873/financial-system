    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('credit', models.ForeignKey(blank=True, default=None, help_text='Garantia del Credito', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='guarantor_client', to='credit.credit')),
            ],
            options={
                'ordering': ['created_at'],
            },
