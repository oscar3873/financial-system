...
class Guarantor(models.Model):
    ...
    credit = models.OneToOneField(Credit, on_delete=models.SET_NULL, blank=True, null=True, default=None, help_text="Garantia del Credito", related_name="guarantor_client")
