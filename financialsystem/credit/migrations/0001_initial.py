    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('condition', models.CharField(choices=[('Pagado', 'Pagado'), ('A Tiempo', 'A Tiempo'), ('Vencido', 'Vencido')], default='A Tiempo', max_length=15)),
                ('interest', models.DecimalField(decimal_places=2, default=40, help_text='Intereses de credito', max_digits=15)),
                ...
                ('start_date', models.DateTimeField(default=django.utils.timezone.now, null=True, verbose_name='Fecha de Inicio')),
                ...
                ('adviser', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='adviser.adviser')),
                ('client', models.ForeignKey(blank=True, default=None, help_text='Cliente del Credito', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='credits', to='clients.client')),
                ('guarantor', models.ForeignKey(blank=True, default=None, help_text='Cliente del Credito', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='credits_g', to='guarantor.guarantor')),
                ('mov', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='cashregister.movement')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('end_date', models.DateTimeField(null=True, verbose_name='Fecha de Finalizacion de Refinanciacion')),
                ('start_date', models.DateTimeField(default=django.utils.timezone.now, null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('credit', models.ForeignKey(blank=True, help_text='Credito de la cuota', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='refinancing', to='credit.credit')),
            ],
            options={
                'ordering': ['-created_at'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id', models.UUIDField(default=uuid.uuid4, editable=False, primary_key=True, serialize=False)),
                ('condition', models.CharField(choices=[('Pagada', 'Pagada'), ('Vencida', 'Vencida'), ('A Tiempo', 'A Tiempo')], default='A Tiempo', max_length=15)),
                ...
                ('porcentage_daily_interests', models.DecimalField(decimal_places=2, default=2, help_text='Intereses diarios', max_digits=20, null=True)),
                ('amount', models.DecimalField(decimal_places=2, help_text='Monto de la cuota de refinanciacion', max_digits=15)),
                ('original_amount', models.DecimalField(decimal_places=2, help_text='Monto de la cuota', max_digits=15)),
                ('payment_date', models.DateTimeField(blank=True, null=True, verbose_name='Fecha de Pago')),
                ('start_date', models.DateTimeField(default=django.utils.timezone.now, verbose_name='Fecha de Inicio')),
                ('end_date', models.DateTimeField(blank=True, default=None, null=True, verbose_name='Fecha de Vencimiento')),
                ('lastup', models.DateField(null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('credit', models.ForeignKey(blank=True, help_text='Credito de la cuota', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='installments_refinancing', to='credit.credit')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('amount', models.DecimalField(decimal_places=2, help_text='Monto de la cuota+Intereses', max_digits=15)),
                ('original_amount', models.DecimalField(decimal_places=2, help_text='Monto de la cuota', max_digits=15)),
                ('lastup', models.DateField(null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
