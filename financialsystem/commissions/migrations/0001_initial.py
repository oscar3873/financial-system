    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('points_score_refinancing', models.DecimalField(blank=True, decimal_places=2, default=80, help_text='Puntos de score', max_digits=5, null=True)),
                ...
                ('daily_interest', models.DecimalField(blank=True, decimal_places=2, default=2, help_text='Disminucion de puntos por retraso diario', max_digits=5, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Commission',
