    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_method', models.CharField(blank=True, choices=[('PESOS', 'PESOS'), ('USD', 'USD'), ('EUR', 'EUR'), ('TRANSFER', 'TRANSFERENCIA'), ('DEBITO', 'DEBITO'), ('CREDITO', 'CREDITO')], default=('PESOS', 'PESOS'), max_length=15, null=True)),
                ...
                ('commission', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='adviser.comission')),
            ],
            options={
                'ordering': ['created_at'],
            },
