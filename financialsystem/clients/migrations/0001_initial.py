    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score_label', models.CharField(blank=True, choices=[('Exelente', 'Exelente'), ('Muy Bueno', 'Muy bueno'), ('Bueno', 'Bueno'), ('Regular', 'Regular'), ('Exelente', 'Exelente'), ('Muy Bueno', 'Muy bueno'), ('Bueno', 'Bueno'), ('Regular', 'Regular'), ('Riesgoso', 'Riesgoso')], max_length=10, null=True, verbose_name='Estado del score')),
