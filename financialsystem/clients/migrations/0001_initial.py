    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveIntegerField(choices=[(600, 'Bueno (600)'), (400, 'Regular (400)'), (200, 'Riesgoso (200)')], default=200, null=True)),
                ('job_address', models.CharField(help_text='Job address', max_length=250, verbose_name='Direccion laboral')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('adviser', models.ForeignKey(blank=True, default=None, help_text='Clientes del usuario', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='user_clients', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='PhoneNumber',
            fields=[
                ...
                ('client', models.ForeignKey(blank=True, default='Some String', on_delete=django.db.models.deletion.CASCADE, to='clients.client')),
            ],
        ),
    ]
