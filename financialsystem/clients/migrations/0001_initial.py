    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('adviser', models.ForeignKey(blank=True, default=None, help_text='Clientes del usuario', null=True, on_delete=django.db.models.deletion.SET_DEFAULT, related_name='user_clients', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='PhoneNumber',
