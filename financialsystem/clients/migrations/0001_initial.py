    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('salary', models.ImageField(blank=True, default=None, null=True, upload_to='salary_checks/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('client', models.ForeignKey(blank=True, default=None, help_text='Recibo de sueldo', null=True, on_delete=django.db.models.deletion.SET_NULL, to='clients.client')),
            ],
        ),
        migrations.CreateModel(
